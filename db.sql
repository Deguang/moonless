...
CREATE TABLE `article` (
  ...
  `tag` char(30) COLLATE utf8_unicode_ci DEFAULT '''''',
...
INSERT INTO `article` VALUES (1,'testTitle','test','testtesttesttest','testtesttesttesttesttesttesttesttesttesttesttesttesttesttesttest',NULL);
...
CREATE TABLE `user` (
  ...
  `name` char(30) COLLATE utf8_unicode_ci DEFAULT '''''',
...
-- Dump completed on 2018-07-02 23:09:01
